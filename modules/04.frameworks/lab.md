...
Initialize a Next.js application by following [this guide](https://nextjs.org/docs/getting-started) to start. Under your repository root, run the `npx create-next-app@latest` and name your application as `client`. It must create the `client` folder.

## Build a website skeleton for blogging (medium level)
...
## Build dynamic routes (medium level)
